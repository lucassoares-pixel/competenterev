export default function ImplantacaoPage() {
  return (
    <div className="page-wrap">
      <h1 style={{ fontSize: 20, fontWeight: 900, margin: '0 0 4px' }}>🚀 Implantação</h1>
      <p style={{ color: 'var(--text-muted)', fontSize: 12, marginBottom: 24 }}>Board de implantação de clientes</p>
